...
const projectData = [
  {
    ...
    client: "Современное производство сэндвич-панелей",
    duration: "Производственная мощность: до 450 000 панелей в год",
    description:
      "Линия оснащена европейским оборудованием с высокой степенью автоматизации. Предприятие ориентировано на крупные строительные проекты по всей стране.",
    image: project1,
    link: "#",
  },
  {
    ...
    duration: "",
    description:
      "Мы применяем утеплители последнего поколения: минеральную вату, ППУ и пенополистирол. Производственный процесс автоматизирован на всех этапах — от резки до упаковки. Это позволяет добиться высокой точности и энергоэффективности продукции.",
    image: project2,
    link: "#",
  },
  {
    ...
    duration: "",
    description:
      "Доставка осуществляется по всей территории Узбекистана. Наш логистический отдел помогает с расчётом сроков и оптимальных маршрутов. Также возможны экспортные поставки в страны региона (Казахстан, Кыргызстан и др.).",
    image: project3,
    link: "#",
  },
];
